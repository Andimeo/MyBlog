...
曼昆的书中表示，该定理的证明所需的数学知识已经超过了该书的范围，于是没有给出证明。我后来Google了关于该定理的证明，其实并没有用到非常艰涩、复杂的数学知识，只用到了基本的逻辑推理。在本文中，我将翻译两个关于该定理的证明，一个是阿罗自己在其博士论文中的证明，另一个则是一位不知姓名的学者给出的非常简短、精炼的证明。
